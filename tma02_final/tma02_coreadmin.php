...
$webdata = array();
$mytable = "TT284rn3396"; //set a variable for the database table
$mytitle = 'Erewon Guest House rn3396'; //Title added/modified 
...
require "tma02_dbconnect.php"; // script to conect to database
