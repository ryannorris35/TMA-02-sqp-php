...
while ($row = mysqli_fetch_array($result)) {
	?>
	<label for="searchcolumn<?php echo $row[0]; ?>"><?php echo $row[0]; ?>:</label><input type="text" name="searchcolumn<?php echo $row[0]; ?>" id="searchcolumn<?php echo $row[0]; ?>"  placeholder="search column <?php echo $row[0]; ?>" maxlength="10" minlength="0" value="" ><br />
	<?php
